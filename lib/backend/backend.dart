...
/// Functions to query EntregasRecords (as a Stream and as a Future).
Future<int> queryEntregasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EntregasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EntregasRecord>> queryEntregasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EntregasRecord.collection,
      EntregasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EntregasRecord>> queryEntregasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
